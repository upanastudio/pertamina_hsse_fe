...
var KTDatatablesSearchOptionsAdvancedSearch = function() {
	...
	var initTable1 = function() {
		...
		table.DataTable({
			...
			serverSide: false,
			ajax: {
				url: '../source/daftar_gsi_permintaan_pekerjaan.json',
				type: 'POST',
				data: {
					pagination: {
						perpage: 50,
	...
	var initTable2 = function() {
		...
		table.DataTable({
			...
			serverSide: false,
			ajax: {
				url: '../source/daftar_gsi_pekerjaan_2.json',
				type: 'POST',
				data: {
					pagination: {
						perpage: 50,
	...
	var initTable3 = function() {
		...
		table.DataTable({
			...
			serverSide: false,
			ajax: {
				url: '../source/daftar_gsi_sika_semua.json',
				type: 'POST',
				data: {
					pagination: {
						perpage: 50,
	...
	var initTable11 = function() {
		...
		table.DataTable({
			...
			serverSide: false,
			ajax: {
				url: '../source/daftar_gsi_sika_pembuatan.json',
				type: 'POST',
				data: {
					pagination: {
						perpage: 50,
	...
	var initTable13 = function() {
		...
		table.DataTable({
			...
			serverSide: false,
			ajax: {
				url: '../source/daftar_gsi_sika_pekerjaan_cold.json',
				type: 'POST',
				data: {
					pagination: {
						perpage: 50,
